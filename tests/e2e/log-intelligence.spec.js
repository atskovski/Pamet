...
test('@production v1.6.9 Log a symptom explains the form, enforces Free limits, and auto-summarizes', async ({ page }, testInfo) => {
...
test('@production v1.6.9 logging milestones and Home observation toggle stay in sync', async ({ page }, testInfo) => {
  await startSyntheticFreeSession(page, testInfo);
