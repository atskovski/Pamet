...
check(cssMain.trim().endsWith('@import "./dark-mode.css";'), 'Unified dark mode must remain the final visual override layer.');
...
console.log(`Pamet ${expected} Insights/design-system checks passed.`);
