...
check(insightsController.includes("label: 'Advanced charting'") && insightsController.includes("feature: 'correlations'") && insightsCharting.includes('Advanced · Pro+'), 'Advanced charting must remain plan-gated while basic charting stays available.');
