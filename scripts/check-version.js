...
check(main.includes("navigator.serviceWorker.register('sw.js?v=1400')"),'PWA registration must reference the 1.4.0 worker.');
...
check(worker.includes(`Pamet v${expected}`)&&worker.includes('pamet-shell-v140-0'),'Service worker cache/version must match release.');
