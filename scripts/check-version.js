...
check(worker.includes(`Pamet v${expected}`)&&worker.includes(`pamet-shell-v${assetVersion}-1`),`Service worker cache must rotate with Pamet ${expected}.`);
...
console.log(`Pamet ${expected} version, CSP, cache-busting, module ownership, dark-mode, and governance checks passed.`);
