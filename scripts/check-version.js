...
check(updateFlow.includes("fetch(`/api/health?release_check=${Date.now()}`") && updateFlow.includes("cache: 'no-store'"), 'The update flow must bypass caches when checking release identity.');
