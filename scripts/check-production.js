...
check(main.includes("navigator.serviceWorker.register('sw.js?v=1230')"), 'PWA service-worker registration must execute from the CSP-compatible external production bundle.');
