...
check(main.includes("navigator.serviceWorker.register('sw.js?v=1500')"), 'PWA service-worker registration must execute from the CSP-compatible external production bundle for Pamet 1.5.0.');
