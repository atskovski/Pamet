...
const performance=fs.readFileSync('js/performance-v1.5.1.js','utf8');
const design=fs.readFileSync('css/design-system-v1.5.0.css','utf8');
const contrast=fs.readFileSync('css/contrast-v1.5.1.css','utf8');
...
check(main.includes("const PAMET_VERSION = '1.5.1'")&&main.includes('performance-v1.5.1.js')&&main.includes('insights-v1.5.0.js')&&main.includes('experience-v1.5.0.js')&&main.includes('icons-v1.5.0.js')&&main.includes('version-update.js'),'1.5.1 runtime modules must be explicit.');
