...
check(phase2.includes('Currently viewing') && phase2.includes('Fresh profile · 0 entries') && phase2.includes('Create &amp; switch'), 'Settings must show the active profile and confirm a fresh profile before switching.');
...
console.log('Pamet 1.3.0 care workspace checks passed.');
