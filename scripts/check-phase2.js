...
const releaseTheme = fs.readFileSync('css/release-v1.0.5.css', 'utf8');
...
check(html.includes('css/phase2.css') && html.includes('js/phase2.js'), 'The v1.0.5 advanced-feature assets must load.');
...
check(releaseTheme.includes('--app-background: #182326') && releaseTheme.includes('--border-color: #7C8F93') && releaseTheme.includes('--text-primary: #F5F8F7'), 'The v1.0.5 neutral dark palette must remain active.');
...
check(server.includes("const VERSION = '1.0.5'"), 'The health endpoint must report v1.0.5.');

console.log('Pamet v1.0.5 advanced-feature checks passed.');
