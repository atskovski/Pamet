/* Pamet v1.5.1 service worker: fast versioned shell caching plus user-approved Web Push; API/share data is never cached. */
const CACHE="pamet-shell-v151-1";
const SHELL=["/","/index.html","/dist/pamet.min.css?v=151","/dist/pamet.min.js?v=151","/manifest.webmanifest","/assets/pamet-mark.svg?v=151","/assets/icon-192.png","/assets/icon-512.png","/assets/icon-maskable-512.png","/assets/login-sunrise.jpg"];
