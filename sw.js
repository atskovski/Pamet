/* Pamet v1.6.2 service worker: release-specific shell caching plus user-approved Web Push; API/share data is never cached. */
const CACHE="pamet-shell-v162-1";
const SHELL=["/","/index.html","/dist/pamet.min.css?v=162","/dist/pamet.min.js?v=162","/manifest.webmanifest","/assets/pamet-mark.svg?v=162","/assets/icon-192.png","/assets/icon-512.png","/assets/icon-maskable-512.png","/assets/login-sunrise.jpg"];
