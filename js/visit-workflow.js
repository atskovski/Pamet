...
(()=>{
  ...
  async function openEmailBrief(){
    ...
    }catch{modalStatus(root,'Pamet could not confirm email delivery. Use Download PDF if sending is unavailable.','warning');send.disabled=false}
